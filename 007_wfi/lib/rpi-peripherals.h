...
#define BUS_ADDRESSES_l2CACHE_ENABLED \
  0x40000000  // Bus Addresses: disable_l2cache0
#define BUS_ADDRESSES_l2CACHE_DISABLED \
  0xC0000000  // Bus Addresses: disable_l2cache1
...
#define MAIL_EMPTY \
  0x40000000  // Mailbox Status Register: Mailbox Empty (There is nothing to
              // read from the Mailbox)
#define MAIL_FULL \
  0x80000000  // Mailbox Status Register: Mailbox Full  (There is no space to
...
// Tags (ARM to VC)
#define Get_Firmware_Revision \
  0x00000001  // VideoCore: Get Firmware Revision (Response: Firmware Revision)
#define Get_Board_Model \
  0x00010001  // Hardware: Get Board Model (Response: Board Model)
#define Get_Board_Revision \
  0x00010002  // Hardware: Get Board Revision (Response: Board Revision)
#define Get_Board_MAC_Address \
  0x00010003  // Hardware: Get Board MAC Address (Response: MAC Address In
              // Network Byte Order)
#define Get_Board_Serial \
  0x00010004  // Hardware: Get Board Serial (Response: Board Serial)
#define Get_ARM_Memory \
  0x00010005  // Hardware: Get ARM Memory (Response: Base Address In Bytes, Size
              // In Bytes)
#define Get_VC_Memory \
  0x00010006  // Hardware: Get VC Memory (Response: Base Address In Bytes, Size
              // In Bytes)
#define Get_Clocks \
  0x00010007  // Hardware: Get Clocks (Response: Parent Clock ID (0 For A Root
              // Clock), Clock ID)
#define Get_Power_State \
  0x00020001  // Power: Get Power State (Response: Device ID, State)
#define Get_Timing \
  0x00020002  // Power: Get Timing (Response: Device ID, Enable Wait Time In
              // Microseconds)
#define Set_Power_State \
  0x00028001  // Power: Set Power State (Response: Device ID, State)
#define Get_Clock_State \
  0x00030001  // Clocks: Get Clock State (Response: Clock ID, State)
#define Get_Clock_Rate \
  0x00030002  // Clocks: Get Clock Rate (Response: Clock ID, Rate In Hz)
#define Get_Voltage \
  0x00030003  // Voltage: Get Voltage (Response: Voltage ID, Value Offset From
              // 1.2V In Units Of 0.025V)
#define Get_Max_Clock_Rate \
  0x00030004  // Clocks: Get Max Clock Rate (Response: Clock ID, Rate In Hz)
#define Get_Max_Voltage \
  0x00030005  // Voltage: Get Max Voltage (Response: Voltage ID, Value Offset
              // From 1.2V In Units Of 0.025V)
#define Get_Temperature \
  0x00030006  // Voltage: Get Temperature (Response: Temperature ID, Value In
              // Degrees C)
#define Get_Min_Clock_Rate \
  0x00030007  // Clocks: Get Min Clock Rate (Response: Clock ID, Rate In Hz)
#define Get_Min_Voltage \
  0x00030008  // Voltage: Get Min Voltage (Response: Voltage ID, Value Offset
              // From 1.2V In Units Of 0.025V)
#define Get_Turbo 0x00030009  // Clocks: Get Turbo (Response: ID, Level)
#define Get_Max_Temperature \
  0x0003000A  // Voltage: Get Max Temperature (Response: Temperature ID, Value
              // In Degrees C)
#define Allocate_Memory \
  0x0003000C  // Memory: Allocates Contiguous Memory On The GPU (Response:
              // Handle)
#define Lock_Memory \
  0x0003000D  // Memory: Lock Buffer In Place, And Return A Bus Address
              // (Response: Bus Address)
#define Unlock_Memory 0x0003000E  // Memory: Unlock Buffer (Response: Status)
#define Release_Memory \
  0x0003000F  // Memory: Free The Memory Buffer (Response: Status)
#define Execute_Code \
  0x00030010  // Memory: Calls The Function At Given (Bus) Address And With
              // Arguments Given
#define Execute_QPU \
  0x00030011  // QPU: Calls The QPU Function At Given (Bus) Address And With
              // Arguments Given (Response: Number Of QPUs, Control, No Flush,
              // Timeout In ms)
#define Enable_QPU 0x00030012  // QPU: Enables The QPU (Response: Enable State)
#define Get_EDID_Block \
  0x00030020  // HDMI: Read Specificed EDID Block From Attached HDMI/DVI Device
              // (Response: Block Number, Status, EDID Block (128 Bytes))
#define Set_Clock_State \
  0x00038001  // Clocks: Set Clock State (Response: Clock ID, State)
#define Set_Clock_Rate \
  0x00038002  // Clocks: Set Clock Rate (Response: Clock ID, Rate In Hz)
#define Set_Voltage \
  0x00038003  // Voltage: Set Voltage (Response: Voltage ID, Value Offset From
              // 1.2V In Units Of 0.025V)
#define Set_Turbo 0x00038009  // Clocks: Set Turbo (Response: ID, Level)
#define Allocate_Buffer \
  0x00040001  // Frame Buffer: Allocate Buffer (Response: Frame Buffer Base
              // Address In Bytes, Frame Buffer Size In Bytes)
#define Blank_Screen 0x00040002  // Frame Buffer: Blank Screen (Response: State)
#define Get_Physical_Display \
  0x00040003  // Frame Buffer: Get Physical (Display) Width/Height (Response:
              // Width In Pixels, Height In Pixels)
#define Get_Virtual_Buffer \
  0x00040004  // Frame Buffer: Get Virtual (Buffer) Width/Height (Response:
              // Width In Pixels, Height In Pixels)
#define Get_Depth \
  0x00040005  // Frame Buffer: Get Depth (Response: Bits Per Pixel)
#define Get_Pixel_Order \
  0x00040006  // Frame Buffer: Get Pixel Order (Response: State)
#define Get_Alpha_Mode \
  0x00040007  // Frame Buffer: Get Alpha Mode (Response: State)
#define Get_Pitch \
  0x00040008  // Frame Buffer: Get Pitch (Response: Bytes Per Line)
#define Get_Virtual_Offset \
  0x00040009  // Frame Buffer: Get Virtual Offset (Response: X In Pixels, Y In
              // Pixels)
#define Get_Overscan \
  0x0004000A  // Frame Buffer: Get Overscan (Response: Top In Pixels, Bottom In
              // Pixels, Left In Pixels, Right In Pixels)
#define Get_Palette \
  0x0004000B  // Frame Buffer: Get Palette (Response: RGBA Palette Values (Index
              // 0 To 255))
#define Test_Physical_Display \
  0x00044003  // Frame Buffer: Test Physical (Display) Width/Height (Response:
              // Width In Pixels, Height In Pixels)
#define Test_Virtual_Buffer \
  0x00044004  // Frame Buffer: Test Virtual (Buffer) Width/Height (Response:
              // Width In Pixels, Height In Pixels)
#define Test_Depth \
  0x00044005  // Frame Buffer: Test Depth (Response: Bits Per Pixel)
#define Test_Pixel_Order \
  0x00044006  // Frame Buffer: Test Pixel Order (Response: State)
#define Test_Alpha_Mode \
  0x00044007  // Frame Buffer: Test Alpha Mode (Response: State)
#define Test_Virtual_Offset \
  0x00044009  // Frame Buffer: Test Virtual Offset (Response: X In Pixels, Y In
              // Pixels)
#define Test_Overscan \
  0x0004400A  // Frame Buffer: Test Overscan (Response: Top In Pixels, Bottom In
              // Pixels, Left In Pixels, Right In Pixels)
#define Test_Palette \
  0x0004400B  // Frame Buffer: Test Palette (Response: RGBA Palette Values
              // (Index 0 To 255))
#define Release_Buffer \
  0x00048001  // Frame Buffer: Release Buffer (Response: Releases And Disables
              // The Frame Buffer)
#define Set_Physical_Display \
  0x00048003  // Frame Buffer: Set Physical (Display) Width/Height (Response:
              // Width In Pixels, Height In Pixels)
#define Set_Virtual_Buffer \
  0x00048004  // Frame Buffer: Set Virtual (Buffer) Width/Height (Response:
              // Width In Pixels, Height In Pixels)
#define Set_Depth \
  0x00048005  // Frame Buffer: Set Depth (Response: Bits Per Pixel)
#define Set_Pixel_Order \
  0x00048006  // Frame Buffer: Set Pixel Order (Response: State)
#define Set_Alpha_Mode \
  0x00048007  // Frame Buffer: Set Alpha Mode (Response: State)
#define Set_Virtual_Offset \
  0x00048009  // Frame Buffer: Set Virtual Offset (Response: X In Pixels, Y In
              // Pixels)
#define Set_Overscan \
  0x0004800A  // Frame Buffer: Set Overscan (Response: Top In Pixels, Bottom In
              // Pixels, Left In Pixels, Right In Pixels)
#define Set_Palette \
  0x0004800B  // Frame Buffer: Set Palette (Response: RGBA Palette Values (Index
              // 0 To 255))
#define Get_Command_Line \
  0x00050001  // Config: Get Command Line (Response: ASCII Command Line String)
#define Get_DMA_Channels \
  0x00060001  // Shared Resource Management: Get DMA Channels (Response: Bits
              // 0-15: DMA channels 0-15)
...
#define CM_MASH_1 \
  0x200  // Clock Control: MASH Control  1-Stage MASH (Equivalent To Non-MASH
         // Dividers)
...
#define DMA_DREQ_STOPS_DMA \
  0x20  // DMA Control & Status: DMA Paused by DREQ State
#define DMA_WAITING_FOR_OUTSTANDING_WRITES \
  0x40  // DMA Control & Status: DMA is Waiting for the Last Write to be
        // Received
...
#define DMA_PANIC_PRIORITY_0 \
  0x0  // DMA Control & Status: AXI Panic Priority Level 0
#define DMA_PANIC_PRIORITY_1 \
  0x100000  // DMA Control & Status: AXI Panic Priority Level 1
#define DMA_PANIC_PRIORITY_2 \
  0x200000  // DMA Control & Status: AXI Panic Priority Level 2
#define DMA_PANIC_PRIORITY_3 \
  0x300000  // DMA Control & Status: AXI Panic Priority Level 3
#define DMA_PANIC_PRIORITY_4 \
  0x400000  // DMA Control & Status: AXI Panic Priority Level 4
#define DMA_PANIC_PRIORITY_5 \
  0x500000  // DMA Control & Status: AXI Panic Priority Level 5
#define DMA_PANIC_PRIORITY_6 \
  0x600000  // DMA Control & Status: AXI Panic Priority Level 6
#define DMA_PANIC_PRIORITY_7 \
  0x700000  // DMA Control & Status: AXI Panic Priority Level 7
#define DMA_PANIC_PRIORITY_8 \
  0x800000  // DMA Control & Status: AXI Panic Priority Level 8
#define DMA_PANIC_PRIORITY_9 \
  0x900000  // DMA Control & Status: AXI Panic Priority Level 9
#define DMA_PANIC_PRIORITY_10 \
  0xA00000  // DMA Control & Status: AXI Panic Priority Level 10
#define DMA_PANIC_PRIORITY_11 \
  0xB00000  // DMA Control & Status: AXI Panic Priority Level 11
#define DMA_PANIC_PRIORITY_12 \
  0xC00000  // DMA Control & Status: AXI Panic Priority Level 12
#define DMA_PANIC_PRIORITY_13 \
  0xD00000  // DMA Control & Status: AXI Panic Priority Level 13
#define DMA_PANIC_PRIORITY_14 \
  0xE00000  // DMA Control & Status: AXI Panic Priority Level 14
#define DMA_PANIC_PRIORITY_15 \
  0xF00000  // DMA Control & Status: AXI Panic Priority Level 14
#define DMA_PANIC_PRIORITY \
  0xF00000  // DMA Control & Status: AXI Panic Priority Level
#define DMA_WAIT_FOR_OUTSTANDING_WRITES \
  0x10000000  // DMA Control & Status: Wait for Outstanding Writes
#define DMA_DISDEBUG \
  0x20000000  // DMA Control & Status: Disable Debug Pause Signal
...
#define DMA_WAIT_RESP \
  0x8  // DMA Transfer Information: Wait for a Write Response
#define DMA_DEST_INC \
  0x10  // DMA Transfer Information: Destination Address Increment
#define DMA_DEST_WIDTH \
  0x20  // DMA Transfer Information: Destination Transfer Width
#define DMA_DEST_DREQ \
  0x40  // DMA Transfer Information: Control Destination Writes with DREQ
...
#define DMA_SRC_DREQ \
  0x400  // DMA Transfer Information: Control Source Reads with DREQ
#define DMA_SRC_IGNORE 0x800  // DMA Transfer Information: Ignore Reads
#define DMA_BURST_LENGTH_1 \
  0x0  // DMA Transfer Information: Burst Transfer Length 1 Word
#define DMA_BURST_LENGTH_2 \
  0x1000  // DMA Transfer Information: Burst Transfer Length 2 Words
#define DMA_BURST_LENGTH_3 \
  0x2000  // DMA Transfer Information: Burst Transfer Length 3 Words
#define DMA_BURST_LENGTH_4 \
  0x3000  // DMA Transfer Information: Burst Transfer Length 4 Words
#define DMA_BURST_LENGTH_5 \
  0x4000  // DMA Transfer Information: Burst Transfer Length 5 Words
#define DMA_BURST_LENGTH_6 \
  0x5000  // DMA Transfer Information: Burst Transfer Length 6 Words
#define DMA_BURST_LENGTH_7 \
  0x6000  // DMA Transfer Information: Burst Transfer Length 7 Words
#define DMA_BURST_LENGTH_8 \
  0x7000  // DMA Transfer Information: Burst Transfer Length 8 Words
#define DMA_BURST_LENGTH_9 \
  0x8000  // DMA Transfer Information: Burst Transfer Length 9 Words
#define DMA_BURST_LENGTH_10 \
  0x9000  // DMA Transfer Information: Burst Transfer Length 10 Words
#define DMA_BURST_LENGTH_11 \
  0xA000  // DMA Transfer Information: Burst Transfer Length 11 Words
#define DMA_BURST_LENGTH_12 \
  0xB000  // DMA Transfer Information: Burst Transfer Length 12 Words
#define DMA_BURST_LENGTH_13 \
  0xC000  // DMA Transfer Information: Burst Transfer Length 13 Words
#define DMA_BURST_LENGTH_14 \
  0xD000  // DMA Transfer Information: Burst Transfer Length 14 Words
#define DMA_BURST_LENGTH_15 \
  0xE000  // DMA Transfer Information: Burst Transfer Length 15 Words
#define DMA_BURST_LENGTH_16 \
  0xF000  // DMA Transfer Information: Burst Transfer Length 16 Words
#define DMA_BURST_LENGTH \
  0xF000  // DMA Transfer Information: Burst Transfer Length
#define DMA_PERMAP_0 \
  0x0  // DMA Transfer Information: Peripheral Mapping Continuous Un-paced
       // Transfer
#define DMA_PERMAP_1 \
  0x10000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 1
#define DMA_PERMAP_2 \
  0x20000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 2
#define DMA_PERMAP_3 \
  0x30000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 3
#define DMA_PERMAP_4 \
  0x40000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 4
#define DMA_PERMAP_5 \
  0x50000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 5
#define DMA_PERMAP_6 \
  0x60000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 6
#define DMA_PERMAP_7 \
  0x70000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 7
#define DMA_PERMAP_8 \
  0x80000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 8
#define DMA_PERMAP_9 \
  0x90000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 9
#define DMA_PERMAP_10 \
  0xA0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 10
#define DMA_PERMAP_11 \
  0xB0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 11
#define DMA_PERMAP_12 \
  0xC0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 12
#define DMA_PERMAP_13 \
  0xD0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 13
#define DMA_PERMAP_14 \
  0xE0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 14
#define DMA_PERMAP_15 \
  0xF0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 15
#define DMA_PERMAP_16 \
  0x100000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 16
#define DMA_PERMAP_17 \
  0x110000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 17
#define DMA_PERMAP_18 \
  0x120000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 18
#define DMA_PERMAP_19 \
  0x130000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 19
#define DMA_PERMAP_20 \
  0x140000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 20
#define DMA_PERMAP_21 \
  0x150000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 21
#define DMA_PERMAP_22 \
  0x160000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 22
#define DMA_PERMAP_23 \
  0x170000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 23
#define DMA_PERMAP_24 \
  0x180000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 24
#define DMA_PERMAP_25 \
  0x190000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 25
#define DMA_PERMAP_26 \
  0x1A0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 26
#define DMA_PERMAP_27 \
  0x1B0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 27
#define DMA_PERMAP_28 \
  0x1C0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 28
#define DMA_PERMAP_29 \
  0x1D0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 29
#define DMA_PERMAP_30 \
  0x1E0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 30
#define DMA_PERMAP_31 \
  0x1F0000  // DMA Transfer Information: Peripheral Mapping Peripheral Number 31
...
#define DMA_NO_WIDE_BURSTS \
  0x4000000  // DMA Transfer Information: Don't Do Wide Writes as a 2 Beat Burst

#define DMA_XLENGTH 0xFFFF  // DMA Transfer Length: Transfer Length in Bytes
#define DMA_YLENGTH \
  0x3FFF0000  // DMA Transfer Length: When in 2D Mode, This is the Y Transfer
              // Length
...
#define DMA_OUTSTANDING_WRITES \
  0xF0                         // DMA Debug: DMA Outstanding Writes Counter
...
#define DMA_INT8 \
  0x100  // DMA Interrupt Status: Interrupt Status of DMA Engine 8
#define DMA_INT9 \
  0x200  // DMA Interrupt Status: Interrupt Status of DMA Engine 9
#define DMA_INT10 \
  0x400  // DMA Interrupt Status: Interrupt Status of DMA Engine 10
#define DMA_INT11 \
  0x800  // DMA Interrupt Status: Interrupt Status of DMA Engine 11
#define DMA_INT12 \
  0x1000  // DMA Interrupt Status: Interrupt Status of DMA Engine 12
#define DMA_INT13 \
  0x2000  // DMA Interrupt Status: Interrupt Status of DMA Engine 13
#define DMA_INT14 \
  0x4000  // DMA Interrupt Status: Interrupt Status of DMA Engine 14
#define DMA_INT15 \
  0x8000  // DMA Interrupt Status: Interrupt Status of DMA Engine 15
...
#define GPIO_FSEL0_ALT0 \
  0x4  // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 0
#define GPIO_FSEL0_ALT1 \
  0x5  // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 1
#define GPIO_FSEL0_ALT2 \
  0x6  // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 2
#define GPIO_FSEL0_ALT3 \
  0x7  // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 3
#define GPIO_FSEL0_ALT4 \
  0x3  // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 4
#define GPIO_FSEL0_ALT5 \
  0x2  // GPIO Function Select: GPIO Pin X0 Takes Alternate Function 5
...
#define GPIO_FSEL1_ALT0 \
  0x20  // GPIO Function Select: GPIO Pin X1 Takes Alternate Function 0
#define GPIO_FSEL1_ALT1 \
  0x28  // GPIO Function Select: GPIO Pin X1 Takes Alternate Function 1
#define GPIO_FSEL1_ALT2 \
  0x30  // GPIO Function Select: GPIO Pin X1 Takes Alternate Function 2
#define GPIO_FSEL1_ALT3 \
  0x38  // GPIO Function Select: GPIO Pin X1 Takes Alternate Function 3
#define GPIO_FSEL1_ALT4 \
  0x18  // GPIO Function Select: GPIO Pin X1 Takes Alternate Function 4
#define GPIO_FSEL1_ALT5 \
  0x10  // GPIO Function Select: GPIO Pin X1 Takes Alternate Function 5
...
#define GPIO_FSEL2_ALT0 \
  0x100  // GPIO Function Select: GPIO Pin X2 Takes Alternate Function 0
#define GPIO_FSEL2_ALT1 \
  0x140  // GPIO Function Select: GPIO Pin X2 Takes Alternate Function 1
#define GPIO_FSEL2_ALT2 \
  0x180  // GPIO Function Select: GPIO Pin X2 Takes Alternate Function 2
#define GPIO_FSEL2_ALT3 \
  0x1C0  // GPIO Function Select: GPIO Pin X2 Takes Alternate Function 3
#define GPIO_FSEL2_ALT4 \
  0xC0  // GPIO Function Select: GPIO Pin X2 Takes Alternate Function 4
#define GPIO_FSEL2_ALT5 \
  0x80  // GPIO Function Select: GPIO Pin X2 Takes Alternate Function 5
...
#define GPIO_FSEL3_ALT0 \
  0x800  // GPIO Function Select: GPIO Pin X3 Takes Alternate Function 0
#define GPIO_FSEL3_ALT1 \
  0xA00  // GPIO Function Select: GPIO Pin X3 Takes Alternate Function 1
#define GPIO_FSEL3_ALT2 \
  0xC00  // GPIO Function Select: GPIO Pin X3 Takes Alternate Function 2
#define GPIO_FSEL3_ALT3 \
  0xE00  // GPIO Function Select: GPIO Pin X3 Takes Alternate Function 3
#define GPIO_FSEL3_ALT4 \
  0x600  // GPIO Function Select: GPIO Pin X3 Takes Alternate Function 4
#define GPIO_FSEL3_ALT5 \
  0x400  // GPIO Function Select: GPIO Pin X3 Takes Alternate Function 5
...
#define GPIO_FSEL4_ALT0 \
  0x4000  // GPIO Function Select: GPIO Pin X4 Takes Alternate Function 0
#define GPIO_FSEL4_ALT1 \
  0x5000  // GPIO Function Select: GPIO Pin X4 Takes Alternate Function 1
#define GPIO_FSEL4_ALT2 \
  0x6000  // GPIO Function Select: GPIO Pin X4 Takes Alternate Function 2
#define GPIO_FSEL4_ALT3 \
  0x7000  // GPIO Function Select: GPIO Pin X4 Takes Alternate Function 3
#define GPIO_FSEL4_ALT4 \
  0x3000  // GPIO Function Select: GPIO Pin X4 Takes Alternate Function 4
#define GPIO_FSEL4_ALT5 \
  0x2000  // GPIO Function Select: GPIO Pin X4 Takes Alternate Function 5
...
#define GPIO_FSEL5_ALT0 \
  0x20000  // GPIO Function Select: GPIO Pin X5 Takes Alternate Function 0
#define GPIO_FSEL5_ALT1 \
  0x28000  // GPIO Function Select: GPIO Pin X5 Takes Alternate Function 1
#define GPIO_FSEL5_ALT2 \
  0x30000  // GPIO Function Select: GPIO Pin X5 Takes Alternate Function 2
#define GPIO_FSEL5_ALT3 \
  0x38000  // GPIO Function Select: GPIO Pin X5 Takes Alternate Function 3
#define GPIO_FSEL5_ALT4 \
  0x18000  // GPIO Function Select: GPIO Pin X5 Takes Alternate Function 4
#define GPIO_FSEL5_ALT5 \
  0x10000  // GPIO Function Select: GPIO Pin X5 Takes Alternate Function 5
...
#define GPIO_FSEL6_OUT \
  0x40000  // GPIO Function Select: GPIO Pin X6 Is An Output
#define GPIO_FSEL6_ALT0 \
  0x100000  // GPIO Function Select: GPIO Pin X6 Takes Alternate Function 0
#define GPIO_FSEL6_ALT1 \
  0x140000  // GPIO Function Select: GPIO Pin X6 Takes Alternate Function 1
#define GPIO_FSEL6_ALT2 \
  0x180000  // GPIO Function Select: GPIO Pin X6 Takes Alternate Function 2
#define GPIO_FSEL6_ALT3 \
  0x1C0000  // GPIO Function Select: GPIO Pin X6 Takes Alternate Function 3
#define GPIO_FSEL6_ALT4 \
  0xC0000  // GPIO Function Select: GPIO Pin X6 Takes Alternate Function 4
#define GPIO_FSEL6_ALT5 \
  0x80000  // GPIO Function Select: GPIO Pin X6 Takes Alternate Function 5
...
#define GPIO_FSEL7_OUT \
  0x200000  // GPIO Function Select: GPIO Pin X7 Is An Output
#define GPIO_FSEL7_ALT0 \
  0x800000  // GPIO Function Select: GPIO Pin X7 Takes Alternate Function 0
#define GPIO_FSEL7_ALT1 \
  0xA00000  // GPIO Function Select: GPIO Pin X7 Takes Alternate Function 1
#define GPIO_FSEL7_ALT2 \
  0xC00000  // GPIO Function Select: GPIO Pin X7 Takes Alternate Function 2
#define GPIO_FSEL7_ALT3 \
  0xE00000  // GPIO Function Select: GPIO Pin X7 Takes Alternate Function 3
#define GPIO_FSEL7_ALT4 \
  0x600000  // GPIO Function Select: GPIO Pin X7 Takes Alternate Function 4
#define GPIO_FSEL7_ALT5 \
  0x400000  // GPIO Function Select: GPIO Pin X7 Takes Alternate Function 5
...
#define GPIO_FSEL8_OUT \
  0x1000000  // GPIO Function Select: GPIO Pin X8 Is An Output
#define GPIO_FSEL8_ALT0 \
  0x4000000  // GPIO Function Select: GPIO Pin X8 Takes Alternate Function 0
#define GPIO_FSEL8_ALT1 \
  0x5000000  // GPIO Function Select: GPIO Pin X8 Takes Alternate Function 1
#define GPIO_FSEL8_ALT2 \
  0x6000000  // GPIO Function Select: GPIO Pin X8 Takes Alternate Function 2
#define GPIO_FSEL8_ALT3 \
  0x7000000  // GPIO Function Select: GPIO Pin X8 Takes Alternate Function 3
#define GPIO_FSEL8_ALT4 \
  0x3000000  // GPIO Function Select: GPIO Pin X8 Takes Alternate Function 4
#define GPIO_FSEL8_ALT5 \
  0x2000000  // GPIO Function Select: GPIO Pin X8 Takes Alternate Function 5
#define GPIO_FSEL8_CLR \
  0x7000000  // GPIO Function Select: GPIO Pin X8 Clear Bits

#define GPIO_FSEL9_IN 0x0  // GPIO Function Select: GPIO Pin X9 Is An Input
#define GPIO_FSEL9_OUT \
  0x8000000  // GPIO Function Select: GPIO Pin X9 Is An Output
#define GPIO_FSEL9_ALT0 \
  0x20000000  // GPIO Function Select: GPIO Pin X9 Takes Alternate Function 0
#define GPIO_FSEL9_ALT1 \
  0x28000000  // GPIO Function Select: GPIO Pin X9 Takes Alternate Function 1
#define GPIO_FSEL9_ALT2 \
  0x30000000  // GPIO Function Select: GPIO Pin X9 Takes Alternate Function 2
#define GPIO_FSEL9_ALT3 \
  0x38000000  // GPIO Function Select: GPIO Pin X9 Takes Alternate Function 3
#define GPIO_FSEL9_ALT4 \
  0x18000000  // GPIO Function Select: GPIO Pin X9 Takes Alternate Function 4
#define GPIO_FSEL9_ALT5 \
  0x10000000  // GPIO Function Select: GPIO Pin X9 Takes Alternate Function 5
#define GPIO_FSEL9_CLR \
  0x38000000  // GPIO Function Select: GPIO Pin X9 Clear Bits
...
#define PCM_TXTHR_0 \
  0x0  // PCM Control & Status: Sets the TX FIFO Threshold at which point the
       // TXW flag is Set when the TX FIFO is Empty
#define PCM_TXTHR_1 \
  0x20  // PCM Control & Status: Sets the TX FIFO Threshold at which point the
        // TXW flag is Set when the TX FIFO is less than Full
#define PCM_TXTHR_2 \
  0x40  // PCM Control & Status: Sets the TX FIFO Threshold at which point the
        // TXW flag is Set when the TX FIFO is less than Full
#define PCM_TXTHR_3 \
  0x60  // PCM Control & Status: Sets the TX FIFO Threshold at which point the
        // TXW flag is Set when the TX FIFO is Full but for one Sample
#define PCM_TXTHR \
  0x60  // PCM Control & Status: Sets the TX FIFO Threshold at which point the
        // TXW flag is Set
#define PCM_RXTHR_0 \
  0x0  // PCM Control & Status: Sets the RX FIFO Threshold at which point the
       // RXR flag is Set when we have a single Sample in the RX FIFO
#define PCM_RXTHR_1 \
  0x80  // PCM Control & Status: Sets the RX FIFO Threshold at which point the
        // RXR flag is Set when the RX FIFO is at least Full
#define PCM_RXTHR_2 \
  0x100  // PCM Control & Status: Sets the RX FIFO Threshold at which point the
         // RXR flag is Set when the RX FIFO is at least Full
#define PCM_RXTHR_3 \
  0x180  // PCM Control & Status: Sets the RX FIFO Threshold at which point the
         // RXR flag is Set when the RX FIFO is Full
#define PCM_RXTHR \
  0x180  // PCM Control & Status: Sets the RX FIFO Threshold at which point the
         // RXR flag is Set
...
#define PCM_TXW \
  0x20000  // PCM Control & Status: Indicates that the TX FIFO needs Writing
#define PCM_RXR \
  0x40000  // PCM Control & Status: Indicates that the RX FIFO needs Reading
#define PCM_TXD \
  0x80000  // PCM Control & Status: Indicates that the TX FIFO can accept Data
#define PCM_RXD \
  0x100000  // PCM Control & Status: Indicates that the RX FIFO contains Data
...
#define PCM_FSI \
  0x100000  // PCM Mode: Frame Sync Invert this logically inverts the Frame Sync
            // Signal
#define PCM_FSM 0x200000  // PCM Mode: Frame Sync Mode
#define PCM_CLKI \
  0x400000  // PCM Mode: Clock Invert this logically inverts the PCM_CLK Signal
...
#define PCM_CH2WID_8 \
  0x0  // PCM Receive & Transmit Configuration: Channel 2 Width 8 bits Wide
#define PCM_CH2WID_9 \
  0x1  // PCM Receive & Transmit Configuration: Channel 2 Width 9 bits Wide
#define PCM_CH2WID_10 \
  0x2  // PCM Receive & Transmit Configuration: Channel 2 Width 10 bits Wide
#define PCM_CH2WID_11 \
  0x3  // PCM Receive & Transmit Configuration: Channel 2 Width 11 bits Wide
#define PCM_CH2WID_12 \
  0x4  // PCM Receive & Transmit Configuration: Channel 2 Width 12 bits Wide
#define PCM_CH2WID_13 \
  0x5  // PCM Receive & Transmit Configuration: Channel 2 Width 13 bits Wide
#define PCM_CH2WID_14 \
  0x6  // PCM Receive & Transmit Configuration: Channel 2 Width 14 bits Wide
#define PCM_CH2WID_15 \
  0x7  // PCM Receive & Transmit Configuration: Channel 2 Width 15 bits Wide
#define PCM_CH2WID_16 \
  0x8  // PCM Receive & Transmit Configuration: Channel 2 Width 16 bits Wide
#define PCM_CH2WID_17 \
  0x9  // PCM Receive & Transmit Configuration: Channel 2 Width 17 bits Wide
#define PCM_CH2WID_18 \
  0xA  // PCM Receive & Transmit Configuration: Channel 2 Width 18 bits Wide
#define PCM_CH2WID_19 \
  0xB  // PCM Receive & Transmit Configuration: Channel 2 Width 19 bits Wide
#define PCM_CH2WID_20 \
  0xC  // PCM Receive & Transmit Configuration: Channel 2 Width 20 bits Wide
#define PCM_CH2WID_21 \
  0xD  // PCM Receive & Transmit Configuration: Channel 2 Width 21 bits Wide
#define PCM_CH2WID_22 \
  0xE  // PCM Receive & Transmit Configuration: Channel 2 Width 22 bits Wide
#define PCM_CH2WID_23 \
  0xF  // PCM Receive & Transmit Configuration: Channel 2 Width 23 bits Wide
#define PCM_CH2WID 0xF  // PCM Receive & Transmit Configuration: Channel 2 Width
#define PCM_CH2WID_24 \
  0x8000  // PCM Receive & Transmit Configuration: Channel 2 Width 24 bits wide
#define PCM_CH2WID_25 \
  0x8001  // PCM Receive & Transmit Configuration: Channel 2 Width 25 bits wide
#define PCM_CH2WID_26 \
  0x8002  // PCM Receive & Transmit Configuration: Channel 2 Width 26 bits wide
#define PCM_CH2WID_27 \
  0x8003  // PCM Receive & Transmit Configuration: Channel 2 Width 27 bits wide
#define PCM_CH2WID_28 \
  0x8004  // PCM Receive & Transmit Configuration: Channel 2 Width 28 bits wide
#define PCM_CH2WID_29 \
  0x8005  // PCM Receive & Transmit Configuration: Channel 2 Width 29 bits wide
#define PCM_CH2WID_30 \
  0x8006  // PCM Receive & Transmit Configuration: Channel 2 Width 30 bits wide
#define PCM_CH2WID_31 \
  0x8007  // PCM Receive & Transmit Configuration: Channel 2 Width 31 bits wide
#define PCM_CH2WID_32 \
  0x8008  // PCM Receive & Transmit Configuration: Channel 2 Width 32 bits wide
#define PCM_CH2POS \
  0x3FF0  // PCM Receive & Transmit Configuration: Channel 2 Position
#define PCM_CH2EN \
  0x4000  // PCM Receive & Transmit Configuration: Channel 2 Enable
#define PCM_CH2WEX \
  0x8000  // PCM Receive & Transmit Configuration: Channel 2 Width Extension Bit
#define PCM_CH1WID_8 \
  0x0  // PCM Receive & Transmit Configuration: Channel 1 Width 8 bits Wide
#define PCM_CH1WID_9 \
  0x10000  // PCM Receive & Transmit Configuration: Channel 1 Width 9 bits Wide
#define PCM_CH1WID_10 \
  0x20000  // PCM Receive & Transmit Configuration: Channel 1 Width 10 bits Wide
#define PCM_CH1WID_11 \
  0x30000  // PCM Receive & Transmit Configuration: Channel 1 Width 11 bits Wide
#define PCM_CH1WID_12 \
  0x40000  // PCM Receive & Transmit Configuration: Channel 1 Width 12 bits Wide
#define PCM_CH1WID_13 \
  0x50000  // PCM Receive & Transmit Configuration: Channel 1 Width 13 bits Wide
#define PCM_CH1WID_14 \
  0x60000  // PCM Receive & Transmit Configuration: Channel 1 Width 14 bits Wide
#define PCM_CH1WID_15 \
  0x70000  // PCM Receive & Transmit Configuration: Channel 1 Width 15 bits Wide
#define PCM_CH1WID_16 \
  0x80000  // PCM Receive & Transmit Configuration: Channel 1 Width 16 bits Wide
#define PCM_CH1WID_17 \
  0x90000  // PCM Receive & Transmit Configuration: Channel 1 Width 17 bits Wide
#define PCM_CH1WID_18 \
  0xA0000  // PCM Receive & Transmit Configuration: Channel 1 Width 18 bits Wide
#define PCM_CH1WID_19 \
  0xB0000  // PCM Receive & Transmit Configuration: Channel 1 Width 19 bits Wide
#define PCM_CH1WID_20 \
  0xC0000  // PCM Receive & Transmit Configuration: Channel 1 Width 20 bits Wide
#define PCM_CH1WID_21 \
  0xD0000  // PCM Receive & Transmit Configuration: Channel 1 Width 21 bits Wide
#define PCM_CH1WID_22 \
  0xE0000  // PCM Receive & Transmit Configuration: Channel 1 Width 22 bits Wide
#define PCM_CH1WID_23 \
  0xF0000  // PCM Receive & Transmit Configuration: Channel 1 Width 23 bits Wide
#define PCM_CH1WID \
  0xF0000  // PCM Receive & Transmit Configuration: Channel 1 Width
#define PCM_CH1WID_24 \
  0x80000000  // PCM Receive & Transmit Configuration: Channel 1 Width 24 bits
              // wide
#define PCM_CH1WID_25 \
  0x80010000  // PCM Receive & Transmit Configuration: Channel 1 Width 25 bits
              // wide
#define PCM_CH1WID_26 \
  0x80020000  // PCM Receive & Transmit Configuration: Channel 1 Width 26 bits
              // wide
#define PCM_CH1WID_27 \
  0x80030000  // PCM Receive & Transmit Configuration: Channel 1 Width 27 bits
              // wide
#define PCM_CH1WID_28 \
  0x80040000  // PCM Receive & Transmit Configuration: Channel 1 Width 28 bits
              // wide
#define PCM_CH1WID_29 \
  0x80050000  // PCM Receive & Transmit Configuration: Channel 1 Width 29 bits
              // wide
#define PCM_CH1WID_30 \
  0x80060000  // PCM Receive & Transmit Configuration: Channel 1 Width 30 bits
              // wide
#define PCM_CH1WID_31 \
  0x80070000  // PCM Receive & Transmit Configuration: Channel 1 Width 31 bits
              // wide
#define PCM_CH1WID_32 \
  0x80080000  // PCM Receive & Transmit Configuration: Channel 1 Width 32 bits
              // wide
#define PCM_CH1POS \
  0x3FF00000  // PCM Receive & Transmit Configuration: Channel 1 Position
#define PCM_CH1EN \
  0x40000000  // PCM Receive & Transmit Configuration: Channel 1 Enable
#define PCM_CH1WEX \
  0x80000000  // PCM Receive & Transmit Configuration: Channel 1 Width Extension
              // Bit
...
#define PCM_GRAY_FLUSH \
  0x4  // PCM Gray Mode Control: Flush the RX Buffer into the RX FIFO
#define PCM_RXLEVEL \
  0x3F0  // PCM Gray Mode Control: The Current Fill Level of the RX Buffer
#define PCM_FLUSHED \
  0xFC00  // PCM Gray Mode Control: The Number of Bits that were Flushed into
          // the RX FIFO
#define PCM_RXFIFOLEVEL \
  0x3F0000  // PCM Gray Mode Control: The Current Level of the RX FIFO
...
// don't add uint32_t which breaks pointer arithmetic
#define TIMER_BASE (PERIPHERAL_BASE + 0x0000B000)

#define TIMER_LOAD (volatile uint32_t *)(TIMER_BASE + 0x400)
#define TIMER_VALUE (volatile uint32_t *)(TIMER_BASE + 0x404)
#define TIMER_CONTROL (volatile uint32_t *)(TIMER_BASE + 0x408)
#define TIMER_IRQ_CLR (volatile uint32_t *)(TIMER_BASE + 0x40C)
#define TIMER_RAWIRQ (volatile uint32_t *)(TIMER_BASE + 0x410)
#define TIMER_MASKEDIRQ (volatile uint32_t *)(TIMER_BASE + 0x414)
#define TIMER_RELOAD (volatile uint32_t *)(TIMER_BASE + 0x418)
#define TIMER_PREDIVIDER (volatile uint32_t *)(TIMER_BASE + 0x41C)
#define TIMER_FREECOUNTER (volatile uint32_t *)(TIMER_BASE + 0x420)

// Interrupt
// don't add uint32_t which breaks pointer arithmetic
#define INTERRUPT_BASE (PERIPHERAL_BASE + 0x0000B000)

#define INTERRUPT_IRQ_BASIC_PENDING \
  (volatile uint32_t *)(INTERRUPT_BASE + 0x200)
#define INTERRUPT_IRQ_PENDING1 (volatile uint32_t *)(INTERRUPT_BASE + 0x204)
#define INTERRUPT_IRQ_PENDING2 (volatile uint32_t *)(INTERRUPT_BASE + 0x208)
#define INTERRUPT_FIQ_CTRL (volatile uint32_t *)(INTERRUPT_BASE + 0x20C)
#define INTERRUPT_ENABLE_IRQS1 (volatile uint32_t *)(INTERRUPT_BASE + 0x210)
#define INTERRUPT_ENABLE_IRQS2 (volatile uint32_t *)(INTERRUPT_BASE + 0x214)
#define INTERRUPT_ENABLE_BASIC_IRQS \
  (volatile uint32_t *)(INTERRUPT_BASE + 0x218)
#define INTERRUPT_DISABLE_IRQS1 (volatile uint32_t *)(INTERRUPT_BASE + 0x21C)
#define INTERRUPT_DISABLE_IRQS2 (volatile uint32_t *)(INTERRUPT_BASE + 0x220)
#define INTERRUPT_DISABLE_BASIC_IRQS \
  (volatile uint32_t *)(INTERRUPT_BASE + 0x224)
